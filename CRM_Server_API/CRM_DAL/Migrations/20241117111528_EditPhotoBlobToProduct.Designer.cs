...
namespace CRM_DAL.Migrations
{
    ...
    [Migration("20241117111528_EditPhotoBlobToProduct")]
    partial class EditPhotoBlobToProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRM_DAL.Entitys.Auth.EmployeeRegisterModel", b =>
                {
            ...
            modelBuilder.Entity("CRM_DAL.Entitys.Deal", b =>
                {
            ...
            modelBuilder.Entity("CRM_DAL.Entitys.DealProduct", b =>
                {
                    b.Property<Guid>("DealId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CRM_DAL.Entitys.Deal", b =>
                {
                    b.HasOne("CRM_DAL.Entitys.Client", "Client")
                        .WithMany("Deals")
            ...
            modelBuilder.Entity("CRM_DAL.Entitys.DealProduct", b =>
                {
                    b.HasOne("CRM_DAL.Entitys.Deal", "Deal")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CRM_DAL.Entitys.Auth.EmployeeRegisterModel", null)
                        .WithMany()
